...
<template>
  <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      ...
      <section v-if="!uslugi.length" class="bg-white px-4 py-8 antialiased dark:bg-gray-900 md:py-16">
        <div
          ...
          <div class="lg:col-span-5 lg:mt-0">
            <a href="#">
              ...
              <img class="mb-4 hidden dark:block md:h-full"
                src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-components-dark.svg" alt="peripherals" />
            </a>
          </div>
          <div class="me-auto place-self-center lg:col-span-7">
            <h1 class="mb-3 text-2xl font-bold leading-tight tracking-tight text-gray-900 dark:text-white md:text-4xl">
              В этой категории еще нет объявлений <br />

            </h1>
            <p class="mb-6 text-gray-500 dark:text-gray-400">
              Станьте первым, к кому обратятся клиенты
            </p>
      ...
      <div v-else class="mb-4 grid gap-4 sm:grid-cols-1 md:mb-8 lg:grid-cols-2 xl:grid-cols-2">
        <div v-for="usluga in uslugi" :key="usluga.id"
          class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div class="h-72 w-full">
            <a :href="route('uslugi.url', [usluga.url])">
              <img class="mx-auto h-full dark:hidden" :src="'https://nedicom.ru/' + usluga.file_path"
                :alt="usluga.usl_name" />
            </a>
          </div>
          <div class="pt-6">
            ...
            <div class="mt-2 flex items-center gap-2">
              <div class="flex items-center">
                <RatingReady :reviewRating="true" :rating="(usluga.review_sum_rating / usluga.review_count).toFixed(2)
                  " />
              </div>

              <p class="text-sm font-medium text-gray-900 dark:text-white">
                отзывов - {{ usluga.review_count }}
              </p>
            </div>

            <ul class="mt-2 flex items-center gap-4 px-0">
