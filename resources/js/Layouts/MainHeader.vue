...
<template>
  ...
  <div
    ...
    class="fixed bottom-0 right-0 flex items-center w-full max-w-xl p-4 text-gray-500 bg-white rounded-lg shadow-sm"
    role="alert"
  >
    <div
    ...
    <button
      type="button"
      @click="Inertia.post(route('cookie'), true, { preserveScroll: true })"
