        ...
        <div class="md:w-2/3 xl:w-1/2 sm:px-6 lg:px-4 py-3 px-3 md:px-0 mx-auto my-3 md:my-12 bg-white overflow-hidden"
          ...
          <div class="grid grid-cols-2">
            ...
            <div class="mx-4 flex items-center flex-col justify-center md:justify-end md:flex-row">
              <div v-if="authid === 1">
                <svg @click="Inertia.post(route('questions.delete', [question.id]))" class="w-6 h-6 text-gray-800"
              ...
              <div class="flex">
                ...
                <a href="#comment" class="flex items-center text-gray-500 hover:text-gray-700">
                  ...
                  <span class="text-sm text-gray-500" itemprop="answerCount"><span v-if="set.answers">{{
                    set.answers.length }}</span><span v-else>0</span></span>
                </a>
          ...
          <div class="my-2 md:my-5">
            ...
            <div class="flex justify-between mt-1">
              <a href="#guarantee" class="text-base font-medium text-blue-700 block hover:underline">Качество
                вопроса</a>
            ...
            <a href="#guarantee" class="text-base font-medium text-blue-700 block text-center w-full hover:underline">{{
              message }}</a>
          </div>
          ...
          <div v-if="set.auth">
            <div v-if="set.auth.id == 1 || set.auth.id == set.question.user_id">
              <div v-if="!cntedt">
                <button type="button" @click="update(), (cntedt = !cntedt)"
          ...
          <p itemprop="text" ref="newBody" :contenteditable="cntedt" class="text-md text-gray-900"
          ...
          <div class="flex justify-center" id="comment">
            <Answers class="sm:px-6 lg:px-4 mx-5 py-12 md:w-4/6 w-full" :answers="set.answers" :question="set.question"
              :authid="set.authid" :type="'question'" :article_id="null" />
          </div>
