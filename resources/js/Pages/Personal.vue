      ...
      >
        ...
        <div class="mb-6">
          ...
          <ul class="list-disc pl-6 space-y-1 text-gray-700">
            ...
            <li>
              иные данные, которые я добровольно указываю при использовании
              сайта
            </li>
          </ul>
        </div>
        ...
        <div class="mb-6">
          ...
          <ul class="list-disc pl-6 space-y-1 text-gray-700">
            ...
            <li>предоставление бесплатных онлайн-расчетов (пенсионный калькулятор, калькулятор неустойки по ДДУ);</li>
        ...
        >
          <h2 class="text-lg font-semibold mb-3 text-gray-800">
            4. Особенности при регистрации в качестве юриста (Перечень персональных данных, на обработку которых дается согласие)
          </h2>
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc pl-6 text-gray-700">
              <li>ФИО;</li>
              <li>контактным данным (телефон, email, address);</li>
          ...
          <div class="mb-4">
            ...
            <ul class="list-disc pl-6 text-gray-700">
              ...
              <li>
                индексацию материалов поисковыми системами (Яндекс, Google).
              </li>
            </ul>
          </div>
          ...
          <div class="mb-3">
            <h3 class="font-semibold text-lg text-gray-800 mb-2">
              4.3. Обработку профессиональных данных
            </h3>
            <ul class="list-disc pl-6 text-gray-700">
              <li>сбор и анализ статистики по материалам;</li>
              <li>расчет конверсии и вовлеченности аудитории;</li>
              <li>хранение истории изменений материалов;</li>
              <li>модерацию материалов администрацией сайта.</li>
            </ul>
          </div>

          <p class="mt-3 text-sm text-gray-600 bg-white/50 p-2 rounded">
            <strong>📢 Публичный доступ</strong> — данные видны всем посетителям
            сайта в профиле юриста, карточках статей и объявлений. Материалы
            индексируются поисковыми системами.
          </p>
          <p class="mt-2 text-sm text-gray-600 bg-white/50 p-2 rounded">
            <strong>✓ Я подтверждаю:</strong> являюсь автором публикуемых
            материалов или имею право на их публикацию, материалы не нарушают
            законодательство РФ и права третьих лиц.
          </p>
        </div>
        ...
        >
          <h2 class="text-lg font-semibold mb-3 text-gray-800">
            5. Доступ к данным в личном кабинете юриста (Перечень персональных данных, на обработку которых дается согласие)
          </h2>
        ...
        >
          <h2 class="text-lg font-semibold mb-3 text-gray-800">
            6. Особенности при регистрации в качестве клиента (если заключен
            договор на оказание услуг):
          </h2>
          <ul class="list-disc pl-6 mb-3 text-gray-700">
            <li>контактным данным (email, телефон);</li>
            <li>истории платежей (суммы, даты, статусы);</li>
            <li>данным о деталях оказания услуги;</li>
          </ul>
          <p class="text-sm text-gray-600">
            <strong
        ...
        >
          ...
          <p class="mb-2 text-gray-700">
            Согласие действует <strong>до достижения целей обработки</strong>:
          </p>
          <ul class="list-disc pl-6 mb-2 text-gray-700">
            <li>
              оказание услуг — до окончания договора и сроков хранения по
              закону;
            </li>
            <li>
              публикация материалов (юристы) — до отзыва согласия или удаления
              аккаунта;
            </li>
            <li>
              статистика — до отзыва согласия (если не препятствует договору).
            </li>
          </ul>
          <p class="text-sm text-gray-600">
            📌 В соответствии с ч. 4 ст. 21 № 152-ФЗ — при достижении цели
            обработки данные уничтожаются в течение 30 дней.
          </p>
        </div>
        ...
        <div class="mb-6">
          ...
          <p class="mt-2 text-sm text-gray-600">
            ⚠️ Отзыв не прекращает обработку, необходимую для исполнения
            договора. Для юристов отзыв влечет удаление опубликованных
            материалов.
          </p>
        </div>
