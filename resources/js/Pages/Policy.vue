...
<template>
  <Head>  
    <title>Политика использования персональных данных</title>
    ...
    <div class="h-screen">
      ...
      <MainHeader :auth="auth" />
       ...
       <div class = "container m-12">
        <h1 class="text-xl my-5">Политика в отношении обработки персональных данных*</h1>
        *Принимая настоящую политику, Вы так же даете 
        <a href="/personal" class="text-blue-500 underline">согласие на обработку персональных данных</a>.<br>
        ...
        <a href="/cookie" class="text-blue-500 underline">правила обработки cookie</a>.<br>
          ...
          <p>Политика <strong>предназначена</strong> для доведения до субъектов персональных данных сведений о&nbsp;порядке обработки персональных данных и мерах по обеспечению безопасности персональных данных владельцем сайта (далее &ndash; Оператор).</p>
          <p>Контактные данные оператора. Адрес - 295000, РФ, Республика Крым, город Симферополь, улица Долгоруковская, 13. +79787217151. ИНН: 920109961268. Мина Марк Анатольевич</p>
          ...
          обеспечивающих их доступность в сети интернет по сетевому адресу <a href="https://nedicom.ru/">https://nedicom.ru/</a>
          (далее - сайт, веб-сайт). Почта сайта (оператора - m6132@yandex.ru)
          </li>
          ...
          <li>Вопросы юристу от пользоваля</li>
          ...
          <li>Обработка специальных категорий персональных данных, касающихся расовой, национальной принадлежности, политических взглядов, религиозных или философских убеждений, интимной жизни, Оператором не осуществляется. В случае, если вопрос пользователя юристу касается указанных данных, пользователь обязан воздержаться от публикации такого вопроса или информации о себе</li>
