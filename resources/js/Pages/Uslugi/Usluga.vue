    ...
    <div>
      <div class="grid grid-cols-1 md:grid-cols-4 py-5">
        <div
          ...
          <div class="flex w-full justify-between md:flex-col md:text-xl md:mt-12 px-2">
            <a class="flex justify-end md:min-w-full md:mx-5 md:p-3 my-1 mr-1 text-gray-600 focus:outline-none transition hover:translate-y-1 lg:hover:translate-x-1 duration-100"
              href="#contacts">
            ...
            <a class="hidden md:flex justify-end md:min-w-full md:mx-5 md:p-3 my-1 mr-1 text-gray-600 focus:outline-none transition hover:translate-y-1 lg:hover:translate-x-1 duration-100"
              href="#description">
        ...
        <div itemscope itemtype="https://schema.org/Product" class="md:col-span-3 px-3 md:px-10 w-full">
          <span v-if="auth" class="">
            <a v-if="
              vars.auth.isadmin == 1 || vars.auth.id == vars.usluga.user_id
            " :href="route('uslugi.edit', usluga.id)"
              class="text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">Редактировать
              объявление</a>
          </span>
          ...
          <Prices :userprices="vars.userprices" :subheader="vars.main_usluga.usl_name" :city="vars.city"
          ...
          <div id="questions" v-if="vars.usluga.popular_question" class="border-b-4 border-indigo-500">
            <div v-if="vars.usluga.popular_question[0].answer" class="pb-12" itemscope
              ...
              <ul class="w-full mx-auto mt-10 md:w-11/12 divide-y shadow-gray-600 shadow-2xl rounded-xl list-none">
                <li v-for="item in vars.usluga.popular_question" :key="item.id" class="py-5 text-base" itemscope
                  ...
                  <details class="group">
                    ...
                    <article class="px-4 pb-4 text-slate-500 text-sm" itemscope itemprop="acceptedAnswer"
