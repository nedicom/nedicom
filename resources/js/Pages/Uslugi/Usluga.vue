...
<template>
  ...
  <div itemscope itemtype="https://schema.org/LegalService">
    ...
    <Mainbanner :statusonimage="usluga.usl_name" :nameonimage="usluga.desc" :mainbannerimg="mainbannerimg" />
    ...
    <Body>
      <div class="py-6">
        ...
        <!-- header 2 -->
        <div itemprop="legalName" class="text-4xl m-12 px-6 font-semibold text-grey text-center">
          {{ usluga.usl_name }}
        </div>
        <!-- header 2 -->
                ...
                <div>
                  <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a :href="route('lawyer', item.id)">
                      <img class="rounded-t-lg" :src="'https://nedicom.ru/' + item?.file_path" alt="" />
                    </a>
                    <div class="p-5">
