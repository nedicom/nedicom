      ...
      <div class="md:col-span-3 md:mt-12 px-3 md:px-10 w-full">
        <div class="flex justify-left p-5">
          <div class="mb-3 md:w-3/6">
                ...
                <div v-if="user.isadmin == 1" class="flex flex-col mb-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option
                        v-for="lawyer in set.lawyers"
                        :key="lawyer.id"
                        v-bind:value="lawyer.id"
            ...
            <!-- author -->
            <Author
              v-if="showMstGoOn == 'author' && auth.isadmin"
              class="mt-5 pt-5"
              :uslugaid="set.uslugi.id"
              :user_id="set.uslugi.user_id"
              :errors="set.errors"
            />
