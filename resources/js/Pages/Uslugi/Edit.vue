            ...
            <div class="mb-3 md:w-3/6">
              ...
              <form @submit.prevent="submit">
                ...
                <div v-if="form.is_main !== true">
                  ...
                  <!-- second usluga -->
                  <div v-if="form.is_second !== true">
                    <span v-if="set.uslugi.second" class="text-sm font-bold">Выберите вторичную категорию услуг.<br />
                      Сейчас - {{ set.uslugi.second.name }}</span>
                ...
                <div class="flex justify-evenly">
                  <div class="">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 mb-5 text-center">
                      до 30 лет
                    </p>
                  </div>
                  <div>
                ...
                <label for="address" class="block text-sm font-medium leading-6 text-gray-900">Адрес (отображается в
                  шапке и на странице услуги в разделе "адреса")</label>
                ...
                <label for="dopadress" class="block text-sm font-medium leading-6 text-gray-900">Дополнительный адрес
                  (не отображается в шапке, только на странице услуги в разделе "адреса")</label>
