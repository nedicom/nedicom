...
<template>
  <section>
    <div
      class="flex flex-col md:flex-row mx-auto 2xl:px-0 px-2"
      itemprop="offers"
      itemscope
    ...
    >
      <div class="bg-white flex items-center">
        <div class="h-72 w-full">
          ...
          >
            <img
              class="h-full md:rounded-lg md:shadow-xl object-cover bg-"
...
-->
        ...
        <div
          v-if="set.offer.review_sum_rating && set.offer.review_count"
