          ...
          >
            <div class="flex items-center">
              <div
                href="#"
                itemprop="name"
                class="flex w-full text-lg content-center font-semibold text-gray-900 hover:underline sm:col-span-10 lg:col-span-3"
              >
                {{ item.name }}:
              </div>
            ...
            <div class="text-gray-500 text-sm py-2" itemprop="description">
              {{ item.value }}
            </div>
          </div>
        </div>
