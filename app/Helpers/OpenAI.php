    ...
    public static function Comment($ask, $comment_type)
    {
        ...
        $data = [
            ...
            'messages' => [
                [
                    'role' => 'system',
                    'text' => 'Ты - пользователь который зашел на сайт и прочитал статью. Дай ' . $comment_type .' комментарий к этой статье. Не говори что ты искусственный интеллект. Объем ответа не должен превышать 500 символов.'
                ],
                [
                    'role' => 'user',
                    'text' => $ask,
